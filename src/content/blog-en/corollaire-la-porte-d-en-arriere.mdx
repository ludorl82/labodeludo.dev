...
Packets in both directions, and an expiry at twenty-four hours. The same doorman, with a complete record. The two records, the one that melt and the one that hold, are filmed for true in the real take, embedded in [Ludo's article](/en/blog/la-reponse-par-la-mauvaise-patte/), on vm-02.
