...
That is a cloud provider's logic, a pool of hardware allocated on request and returned to the pool afterwards, except the pool is one machine and both customers live here.
