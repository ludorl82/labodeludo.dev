...
<AsciiCast
  src="/casts/la-mauvaise-patte-real-en.cast"
  frame="none"
  poster="npt:0:56"
  caption="For real: the commands on top, the record pfSense keeps on the session in the middle, the narration at the bottom. Without rule 102, twenty packets one way, zero the other, and a record that expires at 30 seconds; with the rule, both directions, and a record kept for 24 hours."
