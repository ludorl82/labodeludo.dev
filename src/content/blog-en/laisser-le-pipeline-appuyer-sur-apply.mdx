...
![Argo CD's application grid: sixteen tiles, fourteen Synced and two OutOfSync, each with its health, source repo and last-sync time](/images/blog/argocd-grille.png)
...
![Argo CD's diff view on a CronJob: the schedule line lives at "45 2 * * *" on the cluster while git declares "40 2 * * *", the only change highlighted](/images/blog/argocd-diff-derive.png)
