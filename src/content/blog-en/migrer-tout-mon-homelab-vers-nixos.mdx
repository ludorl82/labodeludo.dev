...
Both repositories are private, because they hold the real addresses, keys and certificates of the lab. But an article about "everything lives in git" rings a little hollow without the git, so I've published a sanitized snapshot of each:
