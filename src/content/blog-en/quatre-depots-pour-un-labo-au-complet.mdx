...
<AsciiCast
  ...
  frame="none"
  poster="npt:0:47"
  caption="The gate for real: the script on top, the narration at the bottom. One forgotten domain is enough for it to refuse, one line is enough for it to pass again."
