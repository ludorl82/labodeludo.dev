...
<AsciiCast
  ...
  disclaimer="✔ This is a real capture, made on September 20, 2026 with asciinema in a dedicated tmux session, with no editing. The machine names are the real ones, the user name is shortened to “ludo”, and only pauses longer than two seconds are shortened."
/>
