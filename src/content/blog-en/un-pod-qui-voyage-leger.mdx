...
<AsciiCast
  ...
  frame="none"
  poster="npt:0:28"
  caption="For real, six weeks after the migration: on top I cordon the node and restart the deployment, at the bottom a kubectl get pods -w watches the old pod die and the new one come back on another node, 12.2 seconds on the shell's stopwatch."
