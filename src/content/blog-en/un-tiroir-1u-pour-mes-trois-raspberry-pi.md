...
> - **Dormant bonus**: the NVMe adapters aren't in use yet. That is a path for later moving off fragile SD/USB storage onto NVMe without touching the physical mount again.
