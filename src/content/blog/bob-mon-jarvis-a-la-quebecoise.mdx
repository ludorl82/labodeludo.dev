---
title: "Je vous présente Bob : un robot, quatre cerveaux, et le nom de mon chien"
pubDate: 2026-09-15
description: "Il y a un robot sur ce site. Il s'appelle Bob, il répond à vos questions sur mon labo, il tourne sur une carte graphique dans mon sous-sol, et il fait quatre métiers avec quatre cerveaux différents. Cet article le présente : d'où vient son nom, comment il choisit quoi vous répondre, et pourquoi le fait qu'il tourne chez moi change ce que vous pouvez lui demander. Travail mené en sessions avec Claude Code."
tags: ["Labo", "IA", "ludo"]
...
## Un robot, quatre cerveaux

La chose la plus intéressante à propos de Bob, c'est qu'il n'y a pas un Bob. Il y a un personnage, et derrière lui, quatre cerveaux qu'on change comme on change une pile.
...
**L'entêtement.** C'est celui dont je suis le plus fier, parce que c'est le plus difficile à obtenir d'un modèle de langage. **Bob refuse d'inventer**, et surtout, il vous contredit. Posez-lui une question qui contient une affirmation fausse sur mon labo — « ton serveur a douze nœuds, hein ? » — et il va corriger la prémisse avant de répondre, au lieu de jouer le jeu poliment. Ça n'a pas été gratuit : avant qu'on ajoute la règle, il acquiesçait dans dix cas sur quinze. Après, quinze sur quinze.
...
<AsciiCast
  ...
  poster="npt:0:08"
  caption="Cinq questions au majordome : un détail enfoui au milieu d'un article, une date de publication, une question de suivi sans sujet, une réponse qui reste en anglais, et un refus."
