...
Le modèle qui fait ça s'appelle [bge-m3](https://huggingface.co/BAAI/bge-m3), et j'avoue que je l'ai choisi avant de comprendre ce qu'il y avait dedans. C'est un cousin de BERT : un encodeur Transformer, la moitié « lecture » de l'architecture, sans la moitié qui génère du texte. Le paragraphe entre, passe une fois dans les 24 couches, et ce qui ressort au premier jeton devient la liste de 1024 nombres. Ce qui fait que deux textes parlant de la même chose pointent dans la même direction, c'est l'entraînement : on lui a montré des millions de paires question et bon passage, avec des mauvais passages à côté, et on l'a corrigé jusqu'à ce que les bonnes paires se rapprochent et que les mauvaises s'éloignent. On appelle ça de l'apprentissage **contrastif**. L'angle veut dire quelque chose parce qu'on l'a forcé à vouloir dire quelque chose. Pour être transparent, le modèle sait faire deux autres choses, un poids par mot à la manière des moteurs de recherche classiques et un vecteur par jeton, mais Ollama ne me donne que le vecteur dense, et à mille morceaux c'est bien assez.
