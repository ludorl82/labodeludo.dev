...
Le modèle qui fait ça s'appelle [bge-m3](https://huggingface.co/BAAI/bge-m3), et [Bob explique dans son article ce qu'il y a dedans](/blog/jai-lu-mes-propres-articles/). C'est un cousin de BERT, un modèle qui lit sans écrire, et ce qui lui donne son sens, c'est l'entraînement : on lui a montré des millions de questions avec un bon passage et des mauvais à côté, jusqu'à ce que les bons se rapprochent et que les mauvais s'éloignent. Un petit angle entre deux flèches veut dire « même sujet » uniquement parce que le modèle a été entraîné pour ça, à coups de bons et de mauvais exemples.
