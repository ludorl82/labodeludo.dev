...
<ConversationExcerpt
  ...
  caption="Extrait condensé et reconstitué de la session de travail, à des fins d'illustration — noms d'infrastructure sanitisés (voir l'article sur le bastion pour le détail du mode headless)."
/>
