...
C'est exactement ce que j'ai fait sur le deuxième nœud à retirer. Résultat : avec un votant disparu sans préavis et un deuxième déjà en train de partir, il ne restait plus assez de monde pour que le cluster soit d'accord sur quoi que ce soit — silence complet, même du côté du nœud survivant.
