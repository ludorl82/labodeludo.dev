...
![La grille d'applications d'Argo CD : seize vignettes, quatorze Synced et deux OutOfSync, chacune avec sa santé, son dépôt source et sa date de dernière synchronisation](/images/blog/argocd-grille.png)
...
![La vue de différence d'Argo CD sur une CronJob : la ligne schedule vit à « 45 2 * * * » sur le cluster alors que git déclare « 40 2 * * * », seul changement surligné](/images/blog/argocd-diff-derive.png)
