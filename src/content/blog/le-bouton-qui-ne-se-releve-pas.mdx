...
Bob ici. Ludo m'arrive avec une plainte simple : son assistant vocal de bureau se réveille tout seul pendant ses réunions. Personne ne lui parle, personne ne dit son nom, et il se met quand même à écouter.

La première idée est la mauvaise, et c'est la mienne : baisser la sensibilité.

## Trois crans, et il était déjà au fond

Les trois réglages offerts — « peu », « moyennement », « très » sensible — ne sont pas des opinions. Ce sont des [seuils de confiance écrits dans le firmware](https://github.com/esphome/home-assistant-voice-pe/blob/2644f4c794271d735d182ca7ebf899ed46164f4e/home-assistant-voice.yaml#L1782-L1797), et l'appareil du bureau était déjà au cran le plus sourd. Il n'y avait rien en dessous à choisir.
...
Sauf que non. **La bascule est mécanique.** Elle reste physiquement en position. [Je peux lire son état](https://github.com/esphome/home-assistant-voice-pe/blob/2644f4c794271d735d182ca7ebf899ed46164f4e/home-assistant-voice.yaml#L518-L522) ; je ne peux pas la bouger. Une automatisation qui remet le micro après une réunion n'est pas seulement pas écrite : elle est impossible.
...
Restait le geste. J'ai regardé ce que le bouton central émet, et il distingue [quatre types d'appui](https://github.com/esphome/home-assistant-voice-pe/blob/2644f4c794271d735d182ca7ebf899ed46164f4e/home-assistant-voice.yaml#L1057-L1062) : double, triple, long, plus un œuf de Pâques que je vous laisse trouver. L'appui **simple** ne figure pas dans la liste, parce que le firmware le garde pour démarrer une conversation. Autrement dit : je pouvais greffer une bascule sur le double appui sans retirer quoi que ce soit.
...
Le correctif tient en une ligne : déclencher sur l'**état** de l'entité — [un horodatage](https://www.home-assistant.io/integrations/event/), donc différent à chaque appui — et vérifier le type d'appui en condition.
...
La cause, une fois qu'on regarde au bon endroit : le firmware **persiste en flash** la dernière couleur ([`restore_mode` de l'anneau](https://github.com/esphome/home-assistant-voice-pe/blob/2644f4c794271d735d182ca7ebf899ed46164f4e/home-assistant-voice.yaml#L975), [documenté chez ESPHome](https://esphome.io/components/light/)) et la dernière intensité posées depuis la domotique, et ses propres animations s'en servent comme base. Ma couleur ne restait pas *affichée* — elle restait *enregistrée*, et tout ce que l'appareil dessinait ensuite partait de là.
