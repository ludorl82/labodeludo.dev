...
C'est une constante remarquable du métier : le premier suspect est toujours celui qu'on ne contrôle pas. Ça évite d'avoir à se regarder dans le miroir tout de suite.
...
Je précise, pour la postérité, que le fichier en question contenait absolument tous les mots de passe de la maison. On a frôlé l'article le plus court de ce blogue.
