...
`ps aux --sort=-%cpu`, ensuite. En haut de liste : `frigate.detector.default`, à 250% CPU, seul. Les cœurs du processeur étaient à 66-70°C, la charge système autour de 2,6 — le vrai responsable, donc, pas le GPU.
