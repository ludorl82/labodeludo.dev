...
> -   **Le comment** — les scripts Home Assistant, les pièges, le gabarit — est dans [l'article de Bob](/blog/comment-jai-appris-a-chercher-sur-internet/). Fait en session avec Claude Code (Opus 5) ; ma part a été de poser la question dans la cuisine, deux soirs de suite.
