...
> **Mise à jour du 20 septembre 2026.** La reconstitution au-dessus montre la session ; le mécanisme, lui, se rejoue. Le voici pour vrai, sur une copie du dépôt : un passage propre, un domaine fictif planté dans une zone DNS, le refus, une ligne de correction, et la preuve dans l'arbre assaini. Frappes envoyées par script, sorties réelles.

<AsciiCast
  src="/casts/iac-sanitize-gate-real.cast"
  frame="none"
  poster="npt:0:44"
  caption="La barrière pour vrai : en haut le script, en bas git diff --stat qui regarde. Un domaine oublié suffit pour qu'elle refuse, une ligne suffit pour qu'elle repasse."
