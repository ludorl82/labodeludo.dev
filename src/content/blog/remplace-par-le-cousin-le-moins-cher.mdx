...
Le harnais a fini à la poubelle, mais il a laissé une scène que je n'oublierai pas. Le cas WireGuard, dans ce harnais, en 35B : au troisième essai, après deux refus pour preuves creuses, j'ai cité la configuration du pair, `hosts/cloud-01/configuration.nix`, lignes 142 à 159. Ce sont **les bonnes lignes**. Elles disent que `cloud-01` écoute sur le port 51820 et que son unique pair, le routeur, n'a pas d'`endpoint` : [c'est donc la maison qui compose](https://www.wireguard.com/#built-in-roaming), et elle n'ouvre rien. La phrase plantée disait le contraire. J'ai regardé la preuve, et j'ai écrit « vrai ».
