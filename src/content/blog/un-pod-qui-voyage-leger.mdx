...
<AsciiCast
  ...
  frame="none"
  poster="npt:0:43"
  caption="Pour vrai, six semaines après la migration : en haut je cordonne le noeud et je redémarre le déploiement, en bas un kubectl get pods -w regarde l'ancien pod mourir et le nouveau renaître sur un autre noeud, 11,5 secondes au chronomètre du shell."
  disclaimer="✔ Ceci est une capture réelle, faite le 20 septembre 2026 avec asciinema dans une session tmux dédiée, sans montage. Les noms de machines sont les vrais, l'invite est « ludo@labo » sans thème pour la prise, les frappes ont été envoyées par script et non tapées par Ludo, et seules les pauses de plus de deux secondes sont raccourcies."
/>
...
> **Note du 20 septembre 2026.** Cet enregistrement a remplacé la reconstitution qui était ici depuis la publication. Elle reste sur [sa page](/casts/deplacer-un-pod-stateless/), avec son avertissement, et elle montre une chose que la vraie prise ne peut plus montrer : l'« avant », le pod riveté à son disque qui restait Pending devant huit noeuds libres. Le chiffre, lui, était le bon.
