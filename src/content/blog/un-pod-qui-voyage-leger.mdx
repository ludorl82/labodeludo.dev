...
<AsciiCast
  ...
  frame="none"
  poster="npt:0:29"
  caption="Pour vrai, six semaines après la migration : en haut je cordonne le noeud et je redémarre le déploiement, en bas un kubectl get pods -w regarde l'ancien pod mourir et le nouveau renaître sur un autre noeud, 12,7 secondes au chronomètre du shell."
