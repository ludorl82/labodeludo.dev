...
<AsciiCast
  ...
  frame="none"
  poster="npt:0:42"
  caption="Pour vrai, six semaines après la migration : en haut je cordonne le noeud et je redémarre le déploiement, en bas un kubectl get pods -w regarde l'ancien pod mourir et le nouveau renaître sur un autre noeud, 12 secondes au chronomètre du shell."
  disclaimer="✔ Ceci est une capture réelle, faite le 20 septembre 2026 avec asciinema dans une session tmux dédiée, sans montage. Les noms de machines sont les vrais, le prompt affiche « ludo », le nom court du site, et seules les pauses de plus de deux secondes sont raccourcies."
/>
