...
- **La sélection des questions suggérées se fait aussi sur mon matériel.** Le texte que les visiteurs tapent ne quitte pas le labo.
...
- **Les données des visiteurs restent au labo.** Les questions posées au robot, et la liste qui en est tirée, ne sont traitées que par des modèles qui roulent sur mon matériel.
